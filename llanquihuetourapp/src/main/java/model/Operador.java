...
public class Operador extends Persona {
    ...
    public void setTipoOperacion(String tipoOperacion) {
        try {
            ...
            System.err.println("Error en tipo operación: " + e.getMessage());
    ...
    public void setZonaOperacion(String zonaOperacion) {
        try {
            if (zonaOperacion == null || zonaOperacion.trim().isEmpty()) {
                throw new IllegalArgumentException("La zona de operación no puede estar vacía");
            }
            this.zonaOperacion = zonaOperacion.trim();
        } catch (IllegalArgumentException e) {
            System.err.println("Error en zona operación: " + e.getMessage());
